...
# The `Tailwind::SubheadComponent` can take the following arguments:
...
# ```erb
# <%= Tailwind::SubheadComponent.new(heading: "Hello world")) do |component| %>
...
# ```
module Tailwind
  class SubheadComponent < Tailwind::Component

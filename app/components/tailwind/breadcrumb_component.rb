...
# ## Example
#
# The `Tailwind::BreadcrumbComponent` uses the [Slots API](https://github.com/github/view_component#slots-experimental) and at least one slot is required for the component to render. Each slot can accept the following parameters:
#
...
#
# ```ruby
# <%= render(Tailwind::BreadcrumbComponent.new) do |component| %>
...
##
module Tailwind
  class BreadcrumbComponent < Tailwind::Component
    ...
    class BreadcrumbItem < Tailwind::Slot

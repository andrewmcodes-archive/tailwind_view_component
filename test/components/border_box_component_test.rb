...
class TailwindBorderBoxComponentTest < Minitest::Test
  include Tailwind::ComponentTestHelpers

  def test_does_not_render_an_empty_box
    render_inline(Tailwind::BorderBoxComponent.new)
  ...
  def test_renders_header
    render_inline(Tailwind::BorderBoxComponent.new) do |component|

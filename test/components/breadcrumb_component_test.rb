...
class TailwindBreadcrumbComponentTest < Minitest::Test
  include Tailwind::ComponentTestHelpers

  def test_does_not_render_if_no_items_provided
    render_inline(Tailwind::BreadcrumbComponent.new)

    refute_component_rendered
  end

  def test_renders_single_item
    render_inline(Tailwind::BreadcrumbComponent.new) do |component|

...
class Tailwind::FetchOrFallbackHelperTest < Minitest::Test
  include Tailwind::FetchOrFallbackHelper

  def test_one_of
    Tailwind::FetchOrFallbackHelper.fallback_raises = false
    ...
    Tailwind::FetchOrFallbackHelper.fallback_raises = true
  end
  ...
  def test_raises_on_fallback_in_non_production
    error = assert_raises Tailwind::FetchOrFallbackHelper::InvalidValueError do
